...
var CarouselComponent = function (_a) {
    ...
    var _l = useState(autoScroll ? initialSlideIndex : 0), slideIndex = _l[0], setSlideIndex = _l[1];
    ...
    useEffect(function () {
        if (ref.current) {
            var slide = ref.current.childNodes[slideIndex];
            if (slide) {
